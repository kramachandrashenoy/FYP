...
co = cohere.Client('ZA6L25IUA9BhtPo9YN0WSVeO8Zw4PTsSgIm1XILg')
...
chunk_size = 1000  # Adjust based on the model's input limits
...
for chunk in text_chunks:
    response = co.generate(
        ...
        max_tokens=300,  # Allows for a detailed summary
        temperature=0.3,  # Keeps the summary deterministic and concise
        stop_sequences=["."]  # Ends generation at a logical stopping point
    )
    # Append the summary of the chunk to the final summary
...
Final Summary: Here is a brief summary of the text:

This case involves an appeal against an order made in February 1950 by the High Court of Bombay (Bavdekar and Chainani JJ. Here is a summary of the text:

The appellant wanted to travel to the United Kingdom for eye treatment and contacted the complainant to arrange the flat he was occupying. The police conducted
a raid on the appellant's residence after paying him Rs. The text describes the events of an appellant being charged for receiving money in exchange for the relinquishment
of his tenancy. Mr. The text describes a legal case from the 1950s regarding a tenant who was illegally charged a sum of money in exchange for the relinquishment of their 
tenancy. The text appears to be a legal document pertaining to a case where a tenant handed over vacant possession of a flat to the complainant, pursuant to an agreement
in which the tenant relinquished no rights and the complainant paid no consideration. The text discusses the meaning of the term "relinquishment" in the context of a lease 
agreement, and how it is different from the term "surrender" as used in the Transfer of Property Act. The text discusses the legal implications of assigning a lease or
transferring a leasehold interest in India without the landlord's consent. Sure, I can summarize the provided text for you. The text discusses the idea of relinquishment,
specifically in the context of a tenant's rights and obligations under a lease agreement. The text is a court order that reverses a conviction because there was no "relinquishment"
as defined in the law for the crime.
'''